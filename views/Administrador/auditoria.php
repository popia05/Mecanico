                ...
                <div class="tarjeta">
                    ...
                    <div class="tab-contenido activo" id="tab-auditoria">
                        <div style="padding: 20px;">
                            ...
                            <table class="tabla">
                                <thead>
                                    <tr><th>TIPO</th><th>ACCION</th><th>DESCRIPCION</th><th>USUARIO</th><th>FECHA</th><th>IP</th></tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="tab-contenido" id="tab-empleados">
                        <div style="padding: 20px;">
                            ...
                            <table class="tabla">
                                <thead>
                                    <tr><th>EMPLEADO</th><th>ROL</th><th>CONTACTO</th><th>ESTADO</th><th>ORDENES</th><th>ULTIMA ACTIVIDAD</th></tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><div style="display: flex; align-items: center; gap: 10px;"><div class="avatar rosa">DG</div><strong>Daniel Garcia Olivas</strong></div></td>
                                        <td><span class="badge badge-gris">Mecanico</span></td>
                                        <td>daniel@automaster.com<br><small style="color: var(--texto-claro);">(430) 065-7387</small></td>
                                        <td><div class="estado-punto"><span class="punto verde"></span> Activo</div></td>
                                        <td><strong>156</strong></td>
                                        <td>Mar 03, 2026 - 08:00</td>
                                    </tr>
                                    <tr>
                                        <td><div style="display: flex; align-items: center; gap: 10px;"><div class="avatar azul">RM</div><strong>Roberto Martinez</strong></div></td>
                                        <td><span class="badge badge-gris">Mecanico</span></td>
                                        <td>roberto@automaster.com<br><small style="color: var(--texto-claro);">(430) 065-7388</small></td>
                                        <td><div class="estado-punto"><span class="punto verde"></span> Activo</div></td>
                    ...
                    <div class="tab-contenido" id="tab-ordenes">
                        <div style="padding: 20px;">
                            ...
                            <table class="tabla">
                                <thead>
                                    <tr><th>ID</th><th>VEHICULO</th><th>CLIENTE</th><th>ESTADO</th><th>MECANICOS</th><th>FECHA</th></tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="tab-contenido" id="tab-inventario">
                        <div style="padding: 20px;">
                            ...
                            <table class="tabla">
                                <thead>
                                    <tr><th>ID</th><th>HERRAMIENTA</th><th>CANTIDAD</th><th>ESTADO</th><th>UBICACION</th></tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="tab-contenido" id="tab-configuracion">
                        <div style="padding: 20px;">
                            ...
                            <div class="config-grid">
                                ...
                                <div class="config-seccion">
                                    <h4>Respaldos</h4>
                                    <div class="config-item"><label>Ultimo respaldo</label><span>Mar 01, 2026 - 03:00</span></div>
                                    <button class="btn btn-secundario" style="width: 100%; margin-top: 15px;">Crear Respaldo Manual</button>
                                </div>
                                <div class="config-seccion">
                                    <h4>Sistema</h4>
