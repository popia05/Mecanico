...
<aside class="sidebar">
    <div class="sidebar-logo">
        <div class="logo-circulo">
            <img src="../../logo.png.png" alt="Auto Master" 
    ...
    <nav class="sidebar-nav">
        <a href="index.php?p=panel" 
           class="nav-item <?= $p === 'panel' ? 'activo' : '' ?>">
